...
n = input('enter the number of subjects :'); % n is the number of subjects in consideration (here, 50)
load('key_features_ext.mat');
features = importdata('ear_features_test.mat'); load('feature_all.mat'); load('iris_feature_test.mat');
...
uni_matrix_test = zeros(80,80);graph_test_1=zeros(80,80);
graph_test_2=zeros(80,80);graph_test_3=zeros(80,80);
